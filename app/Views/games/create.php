    ...
    <div class="w-full max-w-2xl bg-surface-container-low rounded-xl p-8 md:p-12 relative">
        ...
        <form method="POST" action="/games" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold tracking-widest uppercase text-on-surface-variant font-label" for="duration_minutes">
                        Durée estimée (minutes)
                    </label>
                    <input class="w-full bg-surface-container-high border-0 focus:ring-2 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-neutral-600 transition-all duration-200 font-body outline-none" id="duration_minutes" name="duration_minutes" placeholder="60" type="number"/>
                </div>
            </div>

            <div class="grid grid-cols-2 gap-8">
                <div class="space-y-2">
                    <label class="block text-sm font-semibold tracking-widest uppercase text-on-surface-variant font-label" for="min_players">
                        Joueurs min
                    </label>
                    <input class="w-full bg-surface-container-high border-0 focus:ring-2 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-neutral-600 transition-all duration-200 font-body outline-none" id="min_players" name="min_players" placeholder="2" type="number"/>
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-semibold tracking-widest uppercase text-on-surface-variant font-label" for="max_players">
                        Joueurs max
                    </label>
                    <input class="w-full bg-surface-container-high border-0 focus:ring-2 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-neutral-600 transition-all duration-200 font-body outline-none" id="max_players" name="max_players" placeholder="4" type="number"/>
                </div>
            </div>
